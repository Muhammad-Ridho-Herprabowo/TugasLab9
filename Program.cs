...
namespace tugas_lab_9
{
    class Program
    {
        ...
        static void AboutApp()
        {
            ...
            Console.WriteLine("\nNama\t: Muhammad Ridho Herprabowo");
            Console.WriteLine("NIM\t: 19.11.2792");
            Console.WriteLine("Kelas\t: 19 IF 03");

            Console.WriteLine("\n* Dibuat dengan bantuan kawan yang tidak pelit ilmu. Selamat bekerja! :)");
            Console.WriteLine("* https://github.com/Muhammad-Ridho-Herprabowo");
